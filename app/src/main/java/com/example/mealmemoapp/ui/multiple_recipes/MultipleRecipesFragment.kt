...
//
//        val randomIds = List(1) { (600000..700000).random() }
//        observeMultipleRecipesData(randomIds)
//
...
//        // Set up a refresh button or swipe-to-refresh listener to trigger the fetch
//        binding.refreshButton.setOnClickListener {
//            viewModel.getRandomRecipes(forceRefresh = true) // Force refresh data
//        }
